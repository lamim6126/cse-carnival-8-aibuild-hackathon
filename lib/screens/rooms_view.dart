  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final filtered = _db.rooms.where((r) {
          if (_selectedType != 'All' && r.type != _selectedType) return false;
          if (_selectedEquipment != 'All') {
            if (!r.equipment.any((e) => e.toLowerCase().contains(_selectedEquipment.toLowerCase()))) {
              return false;
            }
          }
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Rooms & Laboratories",
                            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        Text("${_db.rooms.length} campus rooms available for classes, labs & bookings",
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: types
                          .map((t) => DropdownMenuItem(
                              value: t, child: Text(t == 'All' ? 'All Types' : t.toUpperCase())))
                          .toList(),
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: equipments
                          .map((e) => DropdownMenuItem(
                              value: e, child: Text(e == 'All' ? 'All Equipment' : e.toUpperCase())))
                          .toList(),
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (confirm == true) _db.deleteRoom(room.id);
                                        },
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                            ...
                                            fontSize: 12,
                                            color: room.bookings.isNotEmpty
